...
if system() == 'Windows':
    ...
    install_requires.append('python-certifi-win32>=1.2')
...
setup(
    ...
    url='https://github.com/mcgarrah/aws-adfs',
    download_url='https://github.com/mcgarrah/aws-adfs/tarball/{}'.format(version),
    author='Venth',
